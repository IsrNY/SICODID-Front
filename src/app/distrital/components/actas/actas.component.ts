...
export class ActasComponent implements OnChanges {
  ...
  ngOnChanges(): void {
    ...
    console.log(this.actas?.candidatos.M)
  ...
  isValidFieldVotos(array:string , position:string, form_field:string) {
    return this.validatorsService.isValidFieldVotos(this.candidatos, array, position,form_field);
  }

  getFieldErrorsVotos(array:string, position:string, form_field:string) {
    return this.validatorsService.getFieldErrorsVotos(this.candidatos, array, position,form_field);
  }
}
