...
export class GruposTrabajoComponent implements OnInit {
  ...
  patchIntegrantes = (integrantes:Integrantes[]):void => {
    ...
    integrantes.forEach(integrante => {
      ...
      this.integrantes.push(this.fb.group({
        ...
        punto_escrutinio:[integrante.punto_escrutinio, [Validators.required]],
  ...
  delete = (index:number, id_integrante:number):void => {
  ...
  deleteIntegrante = (index:number, id_integrante:string):void => {
    if(id_integrante !== '') {
  ...
  saveIntegrante = (index:number):void => {
